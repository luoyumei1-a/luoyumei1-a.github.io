...
# 🏫 About me
---
I am a PhD student in Computer Science at City University of Hong Kong and Southeast University. I was admitted to the [**Special Class for the Gifted Young**](https://en.wikipedia.org/wiki/Special_Class_for_the_Gifted_Young) at Chien-Shiung Wu college in Southeast University at the age of 14, and earned Bachelor degree when I was 18.

Research Interests: I am dedicated to advancing to develop mmWave radar AI-Native sensing systems for dynamic environments, creating holistic sensing methods that span from signal generation to semantic recognition with enhanced privacy, efficiency, and robustness. I have some reviewing experience (see 'Professional Service') and am willing to serve as a reviewer to contribute to the peer-review process. <a href='https://scholar.google.com/citations?user=nOMD2YIAAAAJ'><img src="https://img.shields.io/badge/dynamic/json?label=Google%20Scholar&logo=Google%20Scholar&labelColor=f6f6f6&color=9cf&style=flat&query=$.message&url=https://cdn.jsdelivr.net/gh/luoyumei1-a/luoyumei1-a.github.io@google-scholar-stats/gs_data_shieldsio.json&suffix=%20citations" alt="Google Scholar citations"/></a>.
...
[[DOI]](https://doi.org/10.1109/TMC.2025.3607791) [[Download]](https://cdn.jsdelivr.net/gh/luoyumei1-a/luoyumei1-a.github.io@master/docs/VR_PCT_Enhanced_VR_Semantic_Performance_via_Edge_Client_Collaborative_Multi_modal_Point_Cloud_Transformers_R1.pdf)
...
<!-- 
- 	王帅，卢志强，林丽，`梅洛瑜`. 一种异常事件下的电商物资供需联合预测方法 (E-commerce material supply and demand combined prediction method under abnormal event). *Patent Application*. 2023, CN117058713A.
[[Google Patents]](https://patents.google.com/patent/CN116934380A) [[Download]](https://cdn.jsdelivr.net/gh/luoyumei1-a/luoyumei1-a.github.io@master/docs/2023108941746.pdf)

- 	王帅，左伟健，`梅洛瑜`. 一种预测揽派快递员揽收时间的系统 (System for predicting collecting time of collecting and dispatching courier). *Patent Application*. 2023, CN116644834A.
[[Google Patents]](https://patents.google.com/patent/CN116644834A) [[Download]](https://cdn.jsdelivr.net/gh/luoyumei1-a/luoyumei1-a.github.io@master/docs/2023103875729.pdf)

- 	王帅，江林，曹邹颖，`梅洛瑜`. 基于多方公平的即时配送派单系统 (Instant distribution dispatch system based on multiparty fairness). *Patent Application*. 2023, CN116805227A.
[[Google Patents]](https://patents.google.com/patent/CN116805227A) [[Download]](https://cdn.jsdelivr.net/gh/luoyumei1-a/luoyumei1-a.github.io@master/docs/2023103875786.pdf)

- 	王帅，胡世杰，林丽，夏凯文，`梅洛瑜`. 面向POI的突发公共卫生事件重点区域预测方法及系统 (POI-oriented sudden public health event key area prediction method and system). *Patent Application*. 2023, CN116525132A.
[[Google Patents]](https://patents.google.com/patent/CN116525132A) [[Download]](https://cdn.jsdelivr.net/gh/luoyumei1-a/luoyumei1-a.github.io@master/docs/2023103181421.pdf)

- 	王帅，林丽，夏凯文，许凌艺，`梅洛瑜`. 一种面向应急最后一公里物流的快递员资源分配方法 (Express delivery person resource allocation method for emergency last kilometer logistics). *Patent Application*. 2023, CN117057521A.
[[Google Patents]](https://patents.google.com/patent/CN117057521A) [[Download]](https://cdn.jsdelivr.net/gh/luoyumei1-a/luoyumei1-a.github.io@master/docs/2023103135048.pdf)

- 	王帅，陆瑶，李宗晟，`梅洛瑜`. 基于分层强化学习的即时配送实时合作调度系统 (Instant delivery real-time cooperation scheduling system based on layered reinforcement learning). *Patent Application*. 2022, CN115510664A.
[[Google Patents]](https://patents.google.com/patent/CN115510664A) [[Download]](https://cdn.jsdelivr.net/gh/luoyumei1-a/luoyumei1-a.github.io@master/docs/2022112252370.pdf)
-->
